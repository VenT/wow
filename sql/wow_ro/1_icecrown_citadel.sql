...
UPDATE `script_texts` SET `content_loc3`='text' WHERE (`entry`='ID');
UPDATE `script_texts` SET `content_loc3`='text' WHERE (`entry`='ID');
UPDATE `script_texts` SET `content_loc3`='text' WHERE (`entry`='ID');
...
DELETE FROM script_texts WHERE entry<=-1666015 AND entry>=-1666024;
...
INSERT INTO `script_texts` (`entry`, `content_default`, `sound`, `type`) VALUES ('-1810031', 'You gnats actually hurt me! Perhaps I\'ve toyed with you long enough, now taste the vengeance of the grave!', '17359', '1');

DELETE FROM script_texts WHERE entry<=-1666062 AND entry>=-1666069;
