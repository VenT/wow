...
struct boss_deathbringer_saurfangAI : public ScriptedAI
{
    ...
    switch (urand(0,1)) {
        case 0:
               DoScriptText(-1631103,me,pVictim);
               break;
        case 1:
               DoScriptText(-1631104,me,pVictim);
               break;
        };
    }
